...
data["Education"] = data["Education"].astype('category').cat.rename_categories(['No College', 'Undergraduate', 'Advanced Degree'])
...
# This looks across multiple questions to see if the variance is 0.0.  It the variance is 0.0 then the respondnet 
